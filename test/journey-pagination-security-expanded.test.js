...
const journeyCases = [
  ...
  ["journey moves distributed to approved", () => assert.equal(resolveLeadStatusTransition("distributed", { action: "previous" }).toStatus, "approved")],
  ...
  ["journey rejects skipping backward", () => expectStatus(() => resolveLeadStatusTransition("distributed", { status: "verification" }), 400, /next or previous/)],
  ...
  ["journey rejects next at final stage", () => expectStatus(() => resolveLeadStatusTransition("distributed", { action: "next" }), 400, /final journey stage/)],
