...
const MODELS = {
  ...
  WhatsAppConversation: require("../models/WhatsAppConversation"),
  WhatsAppMessage: require("../models/WhatsAppMessage"),
...
const CASES = Object.freeze([
  ...
  ["whatsapp-inbox/open", "WhatsAppConversation", { status: "open" }, { lastMessageAt: -1, _id: -1 }],
  ["whatsapp-inbox/unread", "WhatsAppConversation", { unreadCount: { $gt: 0 } }, { lastMessageAt: -1, _id: -1 }],
  ["whatsapp-inbox/messages", "WhatsAppMessage", { conversationId: "example-conversation" }, { occurredAt: -1, _id: -1 }],
