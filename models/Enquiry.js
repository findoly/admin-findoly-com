...
const enquirySchema = new mongoose.Schema(
  {
    ...
    requirementAiClarificationMessage: { type: String, default: "", trim: true, maxlength: 1000 },
    requirementAiProviderTitle: { type: String, default: "", trim: true, maxlength: 300 },
    requirementAiProviderDetails: { type: String, default: "", trim: true, maxlength: 2000 },
    requirementAiSchemaVersion: { type: Number, default: 0, min: 0 },
    requirementAiSourceHash: { type: String, default: "", trim: true, maxlength: 64 },
    requirementAiModel: { type: String, default: "", trim: true, maxlength: 120 },
    requirementAiGeneratedAt: { type: Date, default: null },
    requirementAiGenerationCount: { type: Number, default: 0, min: 0 },
    requirementAiApprovedAt: { type: Date, default: null },
    requirementAiApprovedBy: { type: String, default: "", trim: true, maxlength: 254 },
